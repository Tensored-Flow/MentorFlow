...
def test_task_generator():
    ...
    assert len(topics) == 5, f"Should have 5 topics, got {len(topics)}"
    assert len(difficulties) == 3, f"Should have 3 difficulties, got {len(difficulties)}"
